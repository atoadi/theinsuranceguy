          ...
          <AnimatePresence mode="wait">
            ...
            {plan === 'std' ? (
              ...
              >
                ...
                <a href="/diamond-wizard?mode=warrantycheck-eligibility?plan=std" className="block w-full py-4 text-center bg-emerald-700 text-white font-bold rounded-xl hover:bg-emerald-800 transition-colors">
              ...
              >
                ...
                <a href="/diamond-wizard?mode=warrantycheck-eligibility?plan=std" className="block w-full py-4 text-center bg-gold-warning text-black font-bold rounded-xl hover:bg-yellow-500 transition-colors">
                  Check Eligibility for Luxury
                </a>
              </motion.div>
            )}
          </AnimatePresence>
