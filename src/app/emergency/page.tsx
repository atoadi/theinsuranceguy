...
import { Phone, AlertTriangle, Camera, FileText, XCircle, CheckCircle } from 'lucide-react';
      ...
      <section className="py-12 px-6 -mt-10 relative z-10 max-w-4xl mx-auto">
        <div className="bg-white rounded-[32px] shadow-2xl p-8 border border-slate-100">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <a href="tel:022-6489-8282" className="flex flex-col items-center justify-center bg-slate-50 hover:bg-ruby-50 border border-slate-200 hover:border-ruby-200 p-6 rounded-2xl transition-all group">
            ...
            <a href="tel:022-48903009" className="flex flex-col items-center justify-center bg-slate-50 hover:bg-ruby-50 border border-slate-200 hover:border-ruby-200 p-6 rounded-2xl transition-all group">
